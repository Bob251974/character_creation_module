...
def attack(char_name: str, char_class: str) -> str:
    """Функция определяет количество ударов."""
    ...
    if char_class == 'healer':
        return (f'{char_name} нанёс урон противнику равный '
                f'{5 + randint(-3, -1)}')
    return (f'{char_name} не нанес никакго урона')


def defence(char_name: str, char_class: str) -> str:
    """Функция определяет эффективность защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Фукнция определяет способности игрока."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция определяет физическую готовность игрока."""
    if char_class == 'warrior':
...
def main() -> None:
    '''Выводит результаты выбора игрока'''
    run_screensaver()
